...
import os
# Removed Kaggle-specific file listing block for local use

# You can write up to 5GB to the current directory (/kaggle/working/) that gets preserved as output when you create a version using "Save & Run All" 
# You can also write temporary files to /kaggle/temp/, but they won't be saved outside of the current session

path = 'C:/Users/asus/OneDrive/Documents/Github_Projects/Sales_forecast/dataset.txt'
...
data = pd.read_csv('C:/Users/asus/OneDrive/Documents/Github_Projects/Sales_forecast/dataset.txt', parse_dates=['date'], index_col='date')
